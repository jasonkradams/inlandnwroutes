...
# Hiking & Scrambling Guides

Welcome to the Inland NW Routes Hiking & Scrambling portal. As you explore the route guides below, select any destination to discover detailed trail statistics, historical context, geographic overviews, and regional geology reports for each area.

---

## Regional Hiking Destinations & Mountain Ranges

| Regional Range / Area | Peak & Basin Highlights | Guide Link |
| :--- | :--- | :--- |
| **American Selkirks** | Chimney Rock, Harrison Peak, Lion Head | [American Selkirks Guide](american-selkirks.md) |
| **Cabinet Mountains Wilderness** | Snowshoe Peak, A Peak, Leigh Lake | [Cabinet Wilderness Guide](blog/posts/34-cabinet-mountain-wilderness.md) |
| **Proposed Scotchman Peaks** | Scotchman Peak (7,709'), Sawtooth Mountain | [Scotchman Peaks Guide](blog/posts/blog-58-proposed-scotchman-peak-wilderness.md) |
| **Bitterroot Mountains** | St. Joe Lake, Illinois Peak, Stevens Peak | [Bitterroots Guide](bitterroots.md) |
| **Canadian Rockies** | Bugaboos, Fisher Peak, Creston Valley | [Canadian Rockies Guide](canada.md) |
| **Glacier National Park** | Continental Divide & Highline Trails | [Glacier N.P. Guide](glacier-np.md) |

---

## Featured Route: St. Joe Lake & Illinois Peak

St. Joe Lake sits in a high glacial basin at 6,472 feet near the crest of the Bitterroot Mountains. Surrounded by dramatic summits—including Illinois Peak (7,690'), Gold Crown Peak (7,374'), Graves Peak (7,235'), and Unnamed Peak (7,260')—this destination offers backcountry camping, day hiking along the Idaho-Montana Stateline Trail, and alpine scrambling.
...
Just before reaching the lake, the trail opens into an expansive subalpine meadow filled with seasonal wildflowers, offering sweeping views of Gold Crown Peak and Rambikur Waterfall cascading down the valley wall.
...
![St. Joe Lake nestling beneath Gold Crown Peak](assets/images/img-1826-1.jpg)
_St. Joe Lake nestling beneath Gold Crown Peak._
...
### Local Points of Interest & Refreshments
