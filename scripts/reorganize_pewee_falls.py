...
stats:
  - label: Waterbody
    value: Pend Oreille River
  - label: Paddle Distance
    value: 17.5 Miles RT
  - label: River Elevation
    value: 1,990'
  - label: Waterfall Height
    value: 200' (Pewee Falls)
  - label: Launch Site
    value: Boundary Dam Campground Launch
  - label: Launch Coordinates
    value: 48°58′58″N 117°21′02″W
notes:
  - label: Crawford State Park & Gardner Cave Info
    url: https://parks.wa.gov/find-parks/state-parks/crawford-state-park-gardner-cave
  - label: Seattle City Light Boundary Dam History
    url: https://www.seattle.gov/cityarchives/exhibits-and-education/online-exhibits/boundary-dam
...
print("Updated landing image description to Satellite Map of Pend Oreille River & Boundary Dam successfully")
