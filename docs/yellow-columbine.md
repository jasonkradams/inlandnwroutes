...
GENESIS NAME:  Aquilegia flavescent 
DISTRIBUTION:  Alaska and the Pacific North West including Utah & New Mexico
SEASON:  June thru August
MEDICAL USE:  Yellow columbine has been reported to be an antispasmodic to induce sweating and to resolve abnormal growths such as tumors. The seed has been used to treat lice in the hair.
Poisonous:
EDIBILITY:  Yellow columbine has been reported to be an antispasmodic to induce sweating and to resolve abnormal growths such as tumors. The seed has been used to treat lice in the hair.
FEATURES:  Several stems and basal leaves form a bushy perennial columbine one to three feet tall with handsome, clear yellow flowers that are held relatively erect on long stalks rather than nodding. Leaves are usually divided into three, occasionally into two parts (variety *hinckleyana*), with leaflets up to four centimeters long, all carried on petioles up to 20 centimeters in length. Petal blades normally range from eight to sixteen centimeters long, but those of variety *hinckleyana* are only two centimeters long and sixteen millimeters wide. Spurs range from less than four to more than ten centimeters in length, with four to nine centimeters most common.
​LEAVES: The stems are long with three long narrow leaves that protrude from the stem.
Fruits: ​Columbine fruits are **cylindrical pods** that open along the inner side, exposing two rows of smooth seeds. The buds and flowers of the plant hang inverted, whereas the fruit is erect. Columbine (Aquilegia canadensis).
