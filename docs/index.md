...
<div class="photo-card" style="padding: 1.5rem;">
  ...
  <p>Our purpose is to show outdoor enthusiasts where to hike, scramble, ski, paddle, and explore in the
Inland
Northwest. By sharing our knowledge, we hope to inspire people to recreate responsibly and advocate for the
preservation
of these special wilderness places.</p>
</div>

<div class="photo-card" style="padding: 1.5rem;">
  <h3 style="margin-top: 0; color: var(--md-accent-fg-color);">🥾 Before Heading Out</h3>
  <p>Please call the relevant USFS Ranger District a few days before your trip to verify current trail
conditions, road
closures, and fire alerts. If ranger stations are unreachable, contact the Forest Supervisor's office.
Managing agency
contact numbers are listed on each route page.</p>
</div>
...
are no
active closures or wildfire alerts before traveling to trailheads.
