...
stats:
  ...
  - label: Distribution
    icon: earth
    value: Occurring east of the Cascades crest in the northeast counties of Washington; southeastern British Columbia to northeastern Washington, east to southeastern Alberta, northern Idaho, and western Montana.
  - label: Season
    icon: calendar
