...
- label: Edibility
  ...
  value: 'Mariposa-lily (Calochortus spp.) Calochortus spp. **bulbs are edible raw**.
    bulbs are best when cooked.Features:'
...
- '.Medical use: An infusion of the plant has been **taken internally to treat rheumatic
  swellings and to ease the delivery of the placenta**.'
...
- '\*Petals: Outside is white, drying yellowish, and serrulate on the margins. Inside
  the petals are hairy (or strongly bearded), white, and at the base it is yellow
  with a small (1.5 mm), circular, dark, central gland.'
---
