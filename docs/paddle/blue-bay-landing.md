...
- label: Maps icon: map value: IPNF, Fernan lake, Mt. CDA topos
- label: Launch GPS icon: crosshairs-gps value: 47°37’51" n 116°40’51" w
- label: Kootenai County Sheriff icon: shield-account
## value: 208.446.1300
## Blue Bay Landing
## Description
We have added the areas sheriff’s emergency phone numbers for each trip write up under the ranger district
info. if an emergency ocurrs, evaluate your circumstances and call only if needed. The Blue Bay Landing is
along the east shore of the bay, due north of I-90. Altho there isn’t a launch at this site, canoeist and
