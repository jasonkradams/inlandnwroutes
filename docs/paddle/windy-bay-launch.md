...
## Windy Bay Launch
## Description
Windy Bay is one of the larger bays on Lake CDA, and as the name implies, it can be very windy. Up the SE
end of the lake is Lake Creek to paddle up if its windy on Windy Bay.
## Attractions
