...
- label: Elevation icon: terrain value: 1915'
- label: Length and Acreage icon: vector-square value: varies
- label: Maps icon: map value: Spokane, Spokane County
- label: Launch GPS icon: crosshairs-gps value: 47°41′40″ n 117°18′29″ w
...
the water.
## Attractions
Easy Access and a wide river to paddle.
## Directions
