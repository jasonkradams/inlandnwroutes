...
tags:
- Lakes stats:
- label: Paddle Distance icon: map-marker-distance value: 3.5 miles
- label: Elevation icon: terrain value: 1990’
- label: Length and Acreage icon: vector-square value: about 1 .mile to North bay, and .75 to Northeast bay.
  190 acres
- label: Maps icon: map value: Bead Lake Topo
- label: Launch GPS icon: crosshairs-gps value: 48°15’23" n 117°41’38"
