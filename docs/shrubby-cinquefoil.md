...
- label: Distribution
  ...
  value: Shrubby cinquefoil is **widely distributed throughout the northern hemisphere**.
    It is found in Europe, Asia, and North America [149]. In North America, shrubby
...
- label: Medical Use
  ...
  value: The powdered or crushed root or cinquefoil can be used to **stop small cuts
    from bleeding by causing blood vessels to contract**. Cinquefoil is also useful
    and effective as a means of detoxing and has been found helpful in reducing withdrawal
    from addictive alkaloids like nicotine and cocaine. Cinquefoil also has antiseptic
...
- label: Fruits
  ...
  value: Sulfur cinquefoil flowers from early May to July. The fruit is **an achene**
    (a dry fruit with a single seed and thin walls that does not open at maturity;
    for example, a sunflower "seed"). These achenes are shaped like commas and are
