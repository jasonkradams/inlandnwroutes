...
tags:
- Waterfalls stats:
- label: Waterfall icon: waterfall value: Myrtle Creek Falls
- label: Drop icon: arrow-collapse-down value: 100' in two drops
- label: Waterfall Type icon: waterfall value: Tiered
- label: Distance Car to Falls icon: map-marker-distance value: .2 miles
- label: Maps icon: map value: I.P.N.F., KOOTENAI National Wildlife Refuge, Moravia topo
