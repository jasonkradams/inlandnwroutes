...
- label: Elevation icon: terrain value: 1041’
- label: Length and Acreage icon: vector-square value: Varies
- label: Maps icon: map value: Moses Lake S.
- label: Launch GPS icon: crosshairs-gps value: Potholes State Park 46°58’54" N 119°20’52" W Perch Point
  Launch. 46°59’50’ N 119°16’1" W
