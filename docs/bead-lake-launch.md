...
tags:
- Lakes stats:
- label: Paddle Distance icon: map-marker-distance value: 9 miles around the lake
- label: Lake Elevation icon: terrain value: 2833’
- label: Length and Acreage icon: vector-square value: about 9 miles around and 720 acres
- label: Maps icon: map value: w.d.f. & g.,
- label: Launch GPS icon: crosshairs-gps value: 48°17’53" n 117°07’25" w
