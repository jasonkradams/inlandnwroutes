...
- Hunting
- Mt Biking stats:
- label: Event Type icon: hiking value: Day hiking, backpacking, fishing, paddling, hunting, mt biking,
  picnicking, and camping.
- label: Distance icon: map-marker-distance value: up to 25 miles, depending on your activity
- label: Elevation icon: terrain value: 600 verts depending on your activity.
- label: Difficulty icon: speedometer value: easy
- label: Maps icon: map value: BLM website, Pacific Lake & Sullivan Lake topos.
- label: GPS icon: crosshairs-gps value: 47°42’83" n 118°44’47" w
...
## Na. if you have images you want to contribute, contact chic
