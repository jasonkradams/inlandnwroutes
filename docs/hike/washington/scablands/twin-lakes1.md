...
- Paddling
- Equestrian stats:
- label: Event Type icon: hiking value: Day hiking, backpacking, paddling, equestrian
- label: Distance icon: map-marker-distance value: main loop is 1 miles RT
- label: Elevation icon: terrain value: Minimal gain
- label: Difficulty icon: speedometer value: easy
- label: Maps icon: map value: Rocklyn SW, Swanson Lake, BLM brochure
- label: GPS icon: crosshairs-gps value: 47°31’79" n 118°30’35" w
