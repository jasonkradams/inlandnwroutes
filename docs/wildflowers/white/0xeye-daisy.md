...
- label: Features
  ...
  value: "Oxeye daisy (Chrysanthemum leucanthemum) is a pretty little perennial flower\
    ...
    \ by 20 to 30 white petals. However, don\u2019t let this similarity fool you.\
    \ This plant can quickly invade areas of the landscape, making it necessary for\
    \ some oxeye daisy control measures."
- label: Leaves
  icon: leaf
...
- label: '.Poisonous:'
  url: '#'
- label: Look for a yellow disk with a dimple the center.
  url: '#'
- label: The name Daisy is said to come from "day's eye" because the flower closes
    at night.
  url: '#'
- label: the pedal like quality of the rays, distinguish these Daisies from Fleabanes.
  url: '#'
---
