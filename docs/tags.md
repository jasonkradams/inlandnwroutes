...
<div class="tag-filter-controls">
  ...
  <div id="tag-cloud-container" class="tag-cloud-container">
    ...
    <button type="button" class="tag-pill-btn" data-tag="mountains">mountains <span class="tag-count">(1)</span></button>
...
- [Index](lakes/index.md)

</div>
<div class="static-tag-section" data-tag="mountains">
## mountains

Found **1** guide tagged with **mountains**:
