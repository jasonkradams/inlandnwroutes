...
tags:
- Lakes stats:
- label: Paddle Distance icon: map-marker-distance value: Around 3 miles RT
- label: Lake Elevation icon: terrain value: 3020'
- label: Maps icon: map value: Detroit National Forest, Forest Map
- label: Launch GPS icon: crosshairs-gps value: 44°22;29" n 121°59'54'w
- label: Linn County Sheriff icon: shield-account
## value: 541.967.3950
## Clear Lake
...
fresh water springs, and the water temps are just above freezing year round. in ancient time a lava flow
...
## Directions
From Bend, Mount Bachelor, drive NW thru Sisters and and Camp Sherman, turning off onto Hwy 126 heading
