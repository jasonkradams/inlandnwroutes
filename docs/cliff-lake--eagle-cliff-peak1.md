...
Whether before or after the hike, be sure to check out the falls below the parking area. There is an outhouse
here.
...
above the
lake on a steep "route" that you should not be miss. The views from atop Eagle Cliff Peak are stunning.
