...
- Fishing
- Equestrian stats:
- label: Event Type icon: hiking value: Day hiking, paddling, mt biking, fishing, equestrian
- label: Distance icon: map-marker-distance value: 6.5 miles with variations
- label: Elevation icon: terrain value: Minimal
- label: Difficulty icon: speedometer value: easy
- label: Maps icon: map value: BLM maps, FishTrap topo
- label: GPS icon: crosshairs-gps value: 47°21’64" n 117°49’84" w
