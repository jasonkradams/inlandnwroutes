...
stats:
  - label: Event Type
    icon: hiking
    value: Day hiking and mountain biking
  - label: Distance
...
Farragut State Park, Lake Pend Oreille, Beaver Bay, and Buttonhook Bay.

## Hazards

Navigation through timber harvest area; stay oriented along the southern boundary of the cut.

## R & P

Local eateries in Bayview and Athol.
