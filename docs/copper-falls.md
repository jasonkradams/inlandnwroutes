...
tags:
- Waterfalls stats:
- label: Waterfall icon: waterfall value: copper falls
- label: Drop icon: arrow-collapse-down value: 160’
- label: Waterfall Type icon: waterfall value: two tiers
- label: Distance Car to Falls icon: map-marker-distance value: .6 miles
- label: Maps icon: map value: Kanicsu N.F., Eastport topo Bonner Ranger District 267.5561
...
is cool visit in any season. From Hwy 95, turn right SE onto N.F. Road #2517, just past there Moyie River
and across from the Northwest Duty Free Store.
Stay on #2517 for 2.5 miles to the marked trailhead.
A sign points the way to the falls.
## Option #1
...
Springs Waterfall and of course the American Selkirks which has Myrtle Falls and the U. & L. Snow Creek
Falls, and the Kootenai National Wildlife Refuge.
...
## To contribute images, contact chic
