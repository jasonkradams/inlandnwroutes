...
- label: Elevation icon: terrain value: 1571’
- label: Length and Acreage icon: vector-square value: 26.7 miles long & 26,890 acres
- label: Maps icon: map value: Steamboat Rock SW
- label: GPS icon: crosshairs-gps value: 47°52’2" n 119°05’ 54" w
- label: Brant County Sheriff icon: shield-account
## value: 509.754.2011
