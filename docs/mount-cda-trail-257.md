...
Unfortunately, the trees have grown up since I was a kid, and there are no views of the lake.
There used to be a fire lookout tower on top, that I used to do astronomy from.
