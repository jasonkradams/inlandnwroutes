...
- Bc X-contry
- Snowshoe stats:
- label: Event Type icon: ski value: Track Ski, Skate, Hok Ski, Telemark, BC X-Contry, Snowshoe
- label: Distance icon: map-marker-distance value: Four miles RT
- label: Elevation icon: terrain value: +/- ~200 ft
- label: Difficulty icon: speedometer value: Easy
- label: Maps icon: map value: '[Deer Creek Nordic Map](https://parks.state.wa.us/DocumentCenter/View/60)
...
National Scenic Trail #13. There is an outhouse and parking on the south side of the highway and a
compground and porta poty on the north side. There are 12 miles of groomed crosscountry ski trails for track
...
winter, the road section is groomed, and makes for an intermediate ski or snowshoe route.
## Option #2
...
north about 15 miles to Boulder Creek Rd a few miles before the town of Orient. take it west about 12 miles
to the pass.

Note: There are mobile phone friendly maps of the sno-park that you can download to your phone and use off
line. The coordinates are embedded in the map and will pin point your location using your phone's GPS
receiver even without cell phone service. The map is available here:
...
along with the made from scratch ginger, lemon and honey tea to keep you warm from the inside.
